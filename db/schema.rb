...
ActiveRecord::Schema.define(version: 201606222219123) do
  ...
  create_table "offer_saveds", force: :cascade do |t|
    t.integer  "user_id",    limit: 4
  ...
  add_index "offer_saveds", ["offer_id"], name: "index_offer_saveds_on_offer_id", using: :btree
  add_index "offer_saveds", ["user_id"], name: "index_offer_saveds_on_user_id", using: :btree
