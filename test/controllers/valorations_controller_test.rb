...
class ValorationsControllerTest < ActionController::TestCase
  ...
  test "should create valoration" do
    assert_difference('Valoration.count') do
      post :create, valoration: { : @valoration., comment: @valoration.comment, default: @valoration.default, rating: @valoration.rating }
    end
  ...
  test "should update valoration" do
    patch :update, id: @valoration, valoration: { : @valoration., comment: @valoration.comment, default: @valoration.default, rating: @valoration.rating }
    assert_redirected_to valoration_path(assigns(:valoration))
  end
